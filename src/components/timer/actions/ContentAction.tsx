const ContentAction = ({
  ...
  return (
    <div className="bg-opacity-70 relative flex flex-col gap-6 rounded-xl border border-blue-950/40 bg-gray-900/10 p-4 px-10 py-8 text-pretty text-gray-100 backdrop-blur-md">
